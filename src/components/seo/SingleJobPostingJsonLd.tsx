...
function removeExisting() {
  document
    .querySelectorAll<HTMLScriptElement>(
      'script[data-jobposting-json-ld-single="true"]',
    )
...
export default function SingleJobPostingJsonLd(props: Props) {
  useEffect(() => {
    ...
    const applyUrl =
      ...
      (props.applicationMethod === "email" && props.applicationEmail
        ? `mailto:${props.applicationEmail}`
        : undefined);
    ...
    const item = {
      ...
      applicantLocationRequirements: isRemote
        ...
        : undefined,
      url,
      applicationContact: props.applicationEmail
        ? { "@type": "ContactPoint", email: props.applicationEmail }
        : undefined,
    ...
    props.expiresAt,
    props.opportunityType,
    props.region,
    props.applicationMethod,
    props.applicationEmail,
    props.applicationUrl,
    props.salaryMin,
    props.salaryMax,
  ]);
