...
DROP POLICY IF EXISTS "Owners can insert placements" ON public.placements;
DROP POLICY IF EXISTS "Owners can update placements" ON public.placements;
DROP POLICY IF EXISTS "Owners can delete placements" ON public.placements;
